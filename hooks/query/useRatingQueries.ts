import { ratingAPI } from '@/hooks/api/rating.api'
import { useMutation, UseMutationOptions, useQuery, UseQueryOptions } from '@tanstack/react-query'
import { CreateRatingApiRequest, Rating, RatingQuery, UpdateRatingApiRequest } from '../../types'
...
export function useCreateRating(
  options?: UseMutationOptions<string, Error, CreateRatingApiRequest & { storageId: string }>
) {
  return useMutation<string, Error, CreateRatingApiRequest & { storageId: string }>({
...
export function useUpdateRating(
  options?: UseMutationOptions<string, Error, UpdateRatingApiRequest & { renterId: string; storageId: string }>
) {
  return useMutation<string, Error, UpdateRatingApiRequest & { renterId: string; storageId: string }>({
    mutationFn: async (data) => {
