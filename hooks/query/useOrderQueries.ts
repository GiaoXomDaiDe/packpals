import { orderAPI, orderDetailsAPI } from '@/hooks/api'
...
interface queryParams {
  ...
  PageIndex: number
  PageSize: number
  MonthAndYear: string // Format: "MM/yyyy" or "yyyy-MM" for filtering by month/year
}
...
export function useUserOrders(
  ...
  options?: Omit<UseQueryOptions<OrdersSuccessResponse>, 'queryKey' | 'queryFn' | 'enabled' >
) {
  return useQuery({
